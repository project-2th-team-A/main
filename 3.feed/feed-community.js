...
document.addEventListener("DOMContentLoaded", () => {
  // 각기 다른 키워드와 클래스를 처리
  fetchPhotosByKeyword("fitness center", "center");
  fetchPhotosByKeyword("pilates", "pilates");
  fetchPhotosByKeyword("exercise group", "club1");
  fetchPhotosByKeyword("workout together", "club2");
  fetchPhotosByKeyword("crossfit", "club3");
  fetchPhotosByKeyword("tennis", "club4");
});
